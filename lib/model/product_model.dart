...
mixin StaticModel {
  static final List<ProductModel> demoPopularProducts = [
    ProductModel(
  ...
  static final List<ProductModel> demoFlashSaleProducts = [
    ProductModel(
      image: 'https://i.imgur.com/J7mGZ12.png',
      title: "FS - Nike Air Max 270 Really React",
      brandName: "Lipsy london",
  ...
  static final List<ProductModel> demoBestSellersProducts = [
    ProductModel(
      image: "https://i.imgur.com/tXyOMMG.png",
      title: "Green Poplin Ruched Front",
      brandName: "Lipsy london",
  ...
  static final List<ProductModel> kidsProducts = [
    ProductModel(
