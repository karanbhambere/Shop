...
mixin StaticModes {
  static final List<CategoryModel> demoCategoriesWithImage = [
    ...
    CategoryModel(
        title: "Accessories", image: "https://i.imgur.com/3mSE5sN.png"),
  ];

  static final List<CategoryModel> demoCategories = [
    CategoryModel(
      title: "On sale",
